        ...
        source={{
          uri:
            placeDetails.photos == null || placeDetails.photos[0] == null
              ...
              : `https://maps.googleapis.com/maps/api/place/photo?maxwidth=1280&photo_reference=${placeDetails.photos[0].photo_reference}&key=${GOOGLE_MAPS_APIKEY}`,
        }}
      />
      <Card.Title
  ...
  return (
    <View style={tw`flex flex-row mr-3 items-center`}>
      <Avatar.Icon
        ...
        icon={icon}
        color={iconColor}
        style={tw`pl-[0.5px] bg-green-600`}
      />
