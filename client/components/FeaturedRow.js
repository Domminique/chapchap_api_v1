...
<RestaurantCard
   id={143}
   imgUrl="https://ongatarongaionline.co.ke/planter5.png"
   ...
   functional, and aesthetically pleasing . They are also offered in different colors to match the décor of
    ...
    dishes={[
     ...
     image: 'https://ongatarongaionline.co.ke/planter1.png',
     screen: 'MapScreen',
      category:"lamps"
   },
   {
     ...
     teacher: ' Mr. Matheka',
     description: 'Our planters come in different sizes, shapes, and materials, such as ceramic, plastic,and metal, to suit the preferences and budgets of their clients ',
     image: 'https://ongatarongaionline.co.ke/planter2.png',
     screen: 'MapScreen',
   ...
   },
   {
    ...
    teacher: ' Mr. Matheka',
    description: 'Our planters come in different sizes, shapes, and materials, such as ceramic, plastic,and metal, to suit the preferences and budgets of their clients ',
    image: 'https://ongatarongaionline.co.ke/planter3.png',
    screen: 'MapScreen',
     category:"Plants and Planters"
  },
  {
    ...
    teacher: ' Mr. Matheka',
    description: 'Our planters come in different sizes, shapes, and materials, such as ceramic, plastic,and metal, to suit the preferences and budgets of their clients ',
    image: 'https://ongatarongaionline.co.ke/planter4.png',
    screen: 'MapScreen',
     category:"Plants and Planters"
  },
  {
    ...
    teacher: ' Mr. Matheka',
    description: 'Our planters come in different sizes, shapes, and materials, such as ceramic, plastic,and metal, to suit the preferences and budgets of their clients ',
    image: 'https://ongatarongaionline.co.ke/planter5.png',
    screen: 'MapScreen',
     category:"Plants and Planters"
  },
  {
    ...
    teacher: ' Mr. Matheka',
    description: 'Our planters come in different sizes, shapes, and materials, such as ceramic, plastic,and metal, to suit the preferences and budgets of their clients ',
    image: 'https://ongatarongaionline.co.ke/planter6.jpg',
    screen: 'MapScreen',
     category:"Plants and Planters"
  },
   ]}
   ...
   />
        <RestaurantCard
   id={123}
   imgUrl="https://ongatarongaionline.co.ke/ceiling-lamp.jpg"
   name='Rongai Lamps '
   title='Rongai Lamps'
   phonenumber='+254715180530'
   rating={4.5}
   ...
   dishes={[
    ...
    image: 'https://ongatarongaionline.co.ke/ceiling-lamp.jpg',
    screen: 'MapScreen',
     category:"lamps"
  },
   ...
   />
        <RestaurantCard
   id={143}
   imgUrl="https://ongatarongaionline.co.ke/carpet4.jpg"
  ...
  dishes={[]}
   ...
   <RestaurantCard
   id={173}
   imgUrl="https://ongatarongaionline.co.ke/mirrors3.jpg"
...
and restoration and repair services.
 ...
 appeal to our target customers."
   ...
   <RestaurantCard
   id={923}
   imgUrl="https://ongatarongaionline.co.ke/wallart.jpg"
   ...
   <RestaurantCard
   id={1233}
   imgUrl="https://ongatarongaionline.co.ke/frame.jpg"
...
<RestaurantCard
   id={1263}
   imgUrl="https://ongatarongaionline.co.ke/candlediffusers.jpg"
...
<RestaurantCard
   id={1236}
   imgUrl="https://ongatarongaionline.co.ke/fragrance2.jpg"
...
<RestaurantCard
   id={1263}
   imgUrl="https://ongatarongaionline.co.ke/kitchen4.jpg"
  ...
  "
   ...
   <RestaurantCard
   id={1293}
   imgUrl="https://ongatarongaionline.co.ke/basket.jpg"
