...
const RegisterScreen = () => {
  ...
  return (
    ...
    >
     ...
     rounded-full shadow-lg `,
      ...
      <ImageBackground
        ...
        style={{ height: Dimensions.get('window').height / 2.4 }}
      >
     ...
     shadow-lg rounded-sm'
        ...
        <View style={styles.brandView}>
          ...
          <Text  className="text-3xl font-extrabold  text-[#00AA13]"> chapchap</Text>
      ...
      <SafeAreaView  style={styles.buttonView}>
        <View style={{ padding: 30 }}>
          <Text className='text-center text-4xl font-extrabold  text-[#00AA13]'>
            {i18n.t('welcome')}
          </Text>
          <Text  className="text-center p-2 font-extrabold  text-[#00AA13]"> 
          ...
          <View>
              ...
              <Stack space={2}>
                ...
                {!values.isMember && ( 
                 ...
                 <PhoneInput
                   ...
                   onChangeFormattedText={handlePhone}
                   withDarkTheme
                   withShadow
                   autoFocus
                 />
            ...
            <HStack style={styles.forgoPassView} space={1}>
              <Text>
                {values.isMember
   ...
   style={{color:'#00AA13',fontStyle:'italic',fontSize:15,padding:10 }}> 
   <Text > Error</Text>
   </Text></Text>
 )} */}
            <TouchableOpacity
