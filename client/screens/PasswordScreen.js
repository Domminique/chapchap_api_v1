...
import { loginUser, registerUser, forgotPassword, resetPassword, verify } from '../features/user/userSlice'
...
const PaywallScreen = () => {
  ...
  return (
    ...
    className="bg-[#1A2F44] flex-1 pt-6" >
      ...
      <Text className="pt-12 text-xl text-center uppercase text-white font-bold">Have you forgotten your password?</Text>
      ...
      {/* Monthly subscribe */}
       ...
       className="items-center px-10 py-2 bg-[#00AA13] mx-10 rounded-full">
          <Text className="text-white text-md text-center font-bold mb-1">Get Reset Password Link </Text>
